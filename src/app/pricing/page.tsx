...
const faqs = [
  ...
  { q: "Can I cancel anytime?", a: "Yes! Cancel anytime via LemonSqueezy's customer portal. You keep access until the end of your billing period." },
  { q: "How do I contact support?", a: "Go to our Contact page or email support@pixelforge.ai. We typically respond within 24 hours. Pro users get priority support." },
];
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-10">
      <div className="text-center mb-12">
        <span className="inline-block rounded-full bg-violet-500/10 border border-violet-500/20 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-violet-400 mb-4">Pricing</span>
        <h1 className="text-3xl sm:text-4xl font-black">
          Simple, Transparent <span className="gradient-text">Pricing</span>
        </h1>
        <p className="mt-3 text-[#8888a0]">Start free with 5 credits. Upgrade when you need more power.</p>
      </div>
