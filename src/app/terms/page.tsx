  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-sm text-[#aaaabb] leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">5. Intellectual Property</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">6. AI-Generated Content Disclaimer</h2>
          <p className="mt-2">AI-powered tools (background removal, upscaling) rely on machine learning models that may produce imperfect results. We are not liable for any losses arising from the use of AI-processed images. You are responsible for reviewing all output before use.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">7. Subscription & Billing</h2>
          <ul className="mt-2 list-disc pl-5 space-y-1">
            <li>Paid subscriptions are billed monthly through LemonSqueezy</li>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">8. Service Availability</h2>
          <p className="mt-2">We strive for high availability but do not guarantee uninterrupted service. Scheduled maintenance will be announced in advance. We are not liable for downtime caused by third-party services (Replicate, LemonSqueezy, Vercel).</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">9. Limitation of Liability</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">10. Account Termination</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">11. Changes to Terms</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e8e8f0]">12. Contact</h2>
          <p className="mt-2">For questions about these Terms, contact us at <a href="mailto:legal@pixelforge.ai" className="text-violet-400 hover:underline">legal@pixelforge.ai</a>.</p>
        </section>
      </div>
    </div>
  );
